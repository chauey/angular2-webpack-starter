...
// TODO: import { IApi } from './IApi';

'use strict';

@Injectable()
export class StateProvinceApiLocal { // TODO: implements IApi {
  _list: any[];
  ...
  public get(expand?: string, filter?: string, select?: string, orderBy?: string, top?: number, skip?: number, count?: boolean
    , extraHttpRequestParams?: any): Rx.Observable<{ count: number, list: any[] }> {
  ...
  private paging(list, odataTop, odataSkip) {
