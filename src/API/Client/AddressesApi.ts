...
@Injectable()
    export class AddressesApi {
        ...
        , extraHttpRequestParams?: any ) : Rx.Observable<Address[]> {
...
//                     .catch(this.handleError);
 ...
 private handleError (error: Response) {
    ...
    return Rx.Observable.throw(error.json().error || 'Server error');
         ...
         */
        public addressesAddressIdGet (addressId: number, $Select?: string, extraHttpRequestParams?: any ) : Rx.Observable<Address> {
