...
// UNDONE: may need to create "typing file", definition d.ts ambient file since this library does not seem to have, and it's not on the definitely typed site. https://github.com/DefinitelyTyped/DefinitelyTyped http://www.typescriptlang.org/Handbook https://typescript.codeplex.com/wikipage?title=Writing%20Definition%20%28.d.ts%29%20Files http://stackoverflow.com/questions/12687779/how-do-you-produce-a-d-ts-typings-definition-file-from-an-existing-javascript
